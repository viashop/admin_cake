			...
			<section id="center_column" class="col-md-12">
				<div id="breadcrumb" class="clearfix">
					...
					<div class="breadcrumb clearfix">
						...
						<span class="navigation_page"><?php echo @$GLOBALS['ConfiguracaoAtividade']['nome_atividade']; ?></span>
					</div>
					<!-- /Breadcrumb -->			
				</div>
				<h1 class="page-heading product-listing"><?php echo @$GLOBALS['ConfiguracaoAtividade']['nome_atividade']; ?></h1>
						...
						<div class="product-container text-center product-block" itemscope itemtype="http://schema.org/Product">
							<div class="left-block">
								<div class="product-image-container image" align="center">
									...
									<a class="product_img_link"	href="<?php printf('%s/p/%s/%d/', FULL_BASE_URL, \Lib\Tools::slug($nome), $id_produto ); ?>" title="<?php echo $produto['ShopProduto']['nome']; ?>" itemprop="url">
									...
									<?php /* ?>	
									<a class="quick-view btn-outline-inverse btn" href="<?php printf('%s/p/%s/%d/', FULL_BASE_URL, \Lib\Tools::slug($nome), $id_produto; ?>" rel="<?php printf('%s/p/%s/%d/', FULL_BASE_URL, \Lib\Tools::slug($nome), $id_produto; ?>" title="Visualização rápida">
							...
							<div class="right-block">
								<div class="product-meta">
									...
									<h5 itemprop="name" class="name">
										<a class="product-name" href="<?php printf('%s/p/%s/%d/', FULL_BASE_URL, \Lib\Tools::slug($nome), $id_produto ); ?>" title="<?php echo $produto['ShopProduto']['nome']; ?>" itemprop="url">
									...
									<div class="functional-buttons clearfix">
										...
										<div class="compare">
											<a class="add_to_compare compare btn btn-outline-inverse" href="<?php printf('%s/p/%s/%d/', FULL_BASE_URL, \Lib\Tools::slug($nome), $id_produto ); ?>" data-id-product="1" title="Adicionar para comparar">
