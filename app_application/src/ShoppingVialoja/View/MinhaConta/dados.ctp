...
$(document).ready(function(){
    ...
    <?php
    if ($dados['Cliente']['tipo_cadastro'] == 'cnpj') {
    ?>    
        ...
        <div class="row">
            <section id="center_column" class="col-md-12">
                <div id="noSlide" style="display: block;">
                    ...
                    <p class="info-title">
                        Por favor, mantenha suas informações pessoais atualizadas.
                    </p>
                    <p class="required">
                    ...
                    <form id="account-creation_form" class="std box form-horizontal" method="post" name="form" action="<?php echo \Lib\Tools::getUrl(); ?>">
                        <div class="account_creation">
                                ...
                                <div class="col-sm-6" style="font-size:12px; font-weight: lighter;">
                                    <div class="radio-inline">
                                        ...
                                        if (!Validate::isPost()) {
                                            ...
                                            if (!(strcmp("cpf", $dados['Cliente']['tipo_cadastro']))) { echo 'checked="checked"';
                                            }
                                    ...
                                    <div class="radio-inline">
                                        ...
                                        <input name="tipo_cadastro" id="tipo_cnpj" value="cnpj" type="radio" <?php if (!(strcmp("cnpj", $dados['Cliente']['tipo_cadastro']))) {echo 'checked="checked"';} ?>>
                            ...
                            <div class="required form-group" id="id_nome_completo">
                                ...
                                <div class="col-sm-6">
                                    <input id="nome_completo" class="is_required validate form-control" type="text" value="<?php echo $dados['Cliente']['nome']; ?>" name="nome_completo">
                                </div>
                            </div>
                            ...
                            <div class="required form-group" id="id_razao_social" style="display: none;">
                                ...
                                <div class="col-sm-6">
                                    <input id="razao_social" class="is_required validate form-control" type="text" value="<?php echo $dados['Cliente']['razao_social']; ?>" name="razao_social">
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-4">
                                            ...
                                            <select id="sexo" class="form-control" name="sexo">
                                                <option value="" <?php if (!(strcmp("", $dados['Cliente']['id_sexo']))) {echo 'selected="selected"';} ?>>Selecione</option>
                                                <option value="1" <?php if (!(strcmp("1", $dados['Cliente']['id_sexo']))) {echo 'selected="selected"';} ?>>Masculino</option>
                                                <option value="2" <?php if (!(strcmp("2", $dados['Cliente']['id_sexo']))) {echo 'selected="selected"';} ?>>Feminino</option>
                                            </select>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6">
                                            ...
                                            <input id="cpf" class="is_required validate form-control" type="text" value="<?php echo $cipher->decrypt($dados['Cliente']['cpf']); ?>" name="cpf">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6">
                                            ...
                                            <input id="cnpj" class="is_required validate form-control" type="text" value="<?php echo $cipher->decrypt($dados['Cliente']['cnpj']); ?>" name="cnpj">
                                ...
                                <div class="col-sm-6" style="font-size:12px; font-weight: lighter;">
                                    <div class="radio-inline">
                                        ...
                                        if (!Validate::isPost()) {
                                            ...
                                            if (!(strcmp("1", $dados['Cliente']['info_tributo']))) { echo 'checked="checked"';
                                            }
                                    ...
                                    <div class="radio-inline">
                                        ...
                                        <input name="info_tributo" id="info_tributo2" value="2" type="radio" <?php if (!(strcmp("2", $dados['Cliente']['info_tributo']))) {echo 'checked="checked"';} ?>>
                                         Não Contribuinte</label>
                                    </div>
                                    <div class="radio-inline">
                                        <label for="info_tributo3" class="top">
                                        <input name="info_tributo" id="info_tributo3" value="3" type="radio" <?php if (!(strcmp("3", $dados['Cliente']['info_tributo']))) {echo 'checked="checked"';} ?>>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-6">
                                            ...
                                            <input id="ie" class="is_required validate form-control" type="text" value="<?php echo $dados['Cliente']['ie']; ?>" name="ie">
                            ...
                            <div class="required password form-group" id="id_data_nasc">
                                ...
                                <div class="col-sm-3">
                                    <input id="data_nasc" class="is_required validate form-control" type="text" name="data_nasc" value="<?php echo \Lib\Tools::formatToDate( $dados['Cliente']['data_nasc'] ); ?>" onBlur="VerificaData(this.value);">
                            ...
                            <div class="required password form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="telefone_residencial" class="is_required validate form-control" type="tel" name="telefone_residencial" value="<?php echo $dados['Cliente']['telefone_residencial']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="required password form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="telefone_celular" class="is_required validate form-control" type="tel" name="telefone_celular" value="<?php echo $dados['Cliente']['telefone_celular']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="required form-group" id="id_aliases">
                                ...
                                <div class="col-sm-6">
                                    <input id="aliases" class="is_required validate form-control" type="text" value="<?php echo $dados['Cliente']['aliases']; ?>" name="aliases">
                                </div>
                            </div>
                            ...
                            <div class="required form-group" id="id_responsavel" style="display: none;">
                                ...
                                <div class="col-sm-6">
                                    <input id="responsavel" class="is_required validate form-control" type="text" value="<?php echo $dados['Cliente']['responsavel']; ?>" name="responsavel">
                                </div>
                            </div>                             
                            ...
                            <div class="required form-group">
                                ...
                                <div class="col-sm-6">
                                    <input id="email" class="is_required validate form-control" type="email" value="<?php echo $dados['Cliente']['email']; ?>" name="email" required placeholder="Informe seu email">
                                </div>
                            </div>
                            ...
                            <div class="required password form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="senha" class="is_required validate form-control" type="password" name="senha">
                            ...
                            <div class="required password form-group">
                                ...
                                <div class="col-sm-3">
                                    <input id="confirmacao_senha" class="is_required validate form-control" type="password" name="confirmacao_senha">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-8">
                                    <div class="checkbox">
                                        ...
                                        if ($dados['Cliente']['receber_ofertas_shopping'] =='True') {
                                            echo 'checked="checked"';
                                        }

                                        ?>>Receber ofertas da ViaLoja.com por e-mail?</label>

                                    </div>
                                    <div class="checkbox">
                                        <input id="check" type="checkbox" value="True" name="check" required checked="checked">
