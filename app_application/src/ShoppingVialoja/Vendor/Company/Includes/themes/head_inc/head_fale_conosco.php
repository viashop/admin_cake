<head>
    <meta charset="utf-8" />
    <title>Atendimento ao Cliente - ViaLoja Shopping</title>
    <meta name="description" content="Atendimento ao Cliente - Fale conosco" />
    ...
    <link rel="stylesheet" href="/themes/shopping/css/contact-form.css" type="text/css" media="all" />
    ...
    <script type="text/javascript">
        ...
        var contact_fileButtonHtml = 'Escolha um arquivo';
        var contact_fileDefaultHtml = 'Nenhum arquivo selecionado';
    ...
    <script type="text/javascript" src="/themes/shopping/js/contact-form.js"></script>
