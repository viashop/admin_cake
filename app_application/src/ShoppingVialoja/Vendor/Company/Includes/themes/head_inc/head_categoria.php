<head>
	<meta charset="utf-8" />
	<title>Best sales - ViaLoja Shopping</title>
	...
	<script type="text/javascript">
		...
		var mywishlist_url = 'loginada8.html';
		...
		var request = '<?php echo @$GLOBALS['request'] ?>';
		var roundMode = 2;
		var search_url = 'module/leoproductsearch/productsearch.html';
