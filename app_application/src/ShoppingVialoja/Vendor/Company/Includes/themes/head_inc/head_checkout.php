<head>
	<meta charset="utf-8" />
	<title>Order - ViaLoja Shopping</title>
	...
	<link rel="stylesheet" href="/themes/shopping/css/addresses.css" type="text/css" media="all" />
	...
	<script type="text/javascript">
		...
		var txtProduct = 'produto';
		var txtProducts = 'produtos';
	...
	<script type="text/javascript" src="/themes/shopping/js/cart-summary.js"></script>
