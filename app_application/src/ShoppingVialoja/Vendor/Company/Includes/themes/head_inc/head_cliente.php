<head>
	<meta charset="utf-8" />
	<title>Login - ViaLoja Shopping</title>
	...
	<link rel="stylesheet" href="/themes/shopping/css/authentication.css" type="text/css" media="all" />
	...
	<script type="text/javascript">
		...
		var mywishlist_url = '/br/module/blockwishlist/mywishlist';
		...
		var roundMode = 2;
		var search_url = '/br/module/leoproductsearch/productsearch';
		var static_token = <?php echo sprintf("'%s';", \Lib\Tools::uniqid() ) . PHP_EOL; ?>;
		var token = <?php echo sprintf("'%s';", \Lib\Tools::uniqid() ) . PHP_EOL; ?>;
	...
	<script type="text/javascript" src="/themes/shopping/js/authentication.js"></script>
