                ...
                <div class="box">
                    ...
                    <form action="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/address" method="post" class="std form-horizontal" id="add_address">
                        ...
                        <p class="submit2 text-right">
                            <input type="hidden" name="id_address" value="0" />									<input type="hidden" name="select_address" value="0" />			<input type="hidden" name="token" value="5771fa59620f25a620a58629d536021c" />		
