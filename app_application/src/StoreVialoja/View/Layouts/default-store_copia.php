...
<html dir="ltr" class="ltr" lang="pt-BR">
	...
	if (defined('PRODUTO_SHOP_LOJA')) {
		...
		echo '<body id="offcanvas-container" class="  catalog-product-view catalog-product-view product-framed-sleeve-mid categorypath-desktops-7-html category-desktops offcanvas-container layout-fullwidth fs13  ">';
	}
