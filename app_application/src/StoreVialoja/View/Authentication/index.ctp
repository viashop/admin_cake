					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<form action="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/login" method="post" id="create-account_form" class="box">
							...
							<div class="form_content clearfix">
								...
								<div class="submit">
									<input type="hidden" class="hidden" name="back" value="login8fce.html?step=1&amp;multi-shipping=0" />						<button class="btn btn-default button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate">
									<span>
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<form action="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/login" method="post" id="login_form" class="box">
							...
							<div class="form_content clearfix">
								...
								<p class="submit">
									<input type="hidden" class="hidden" name="back" value="login8fce.html?step=1&amp;multi-shipping=0" />						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium">
									<span>
