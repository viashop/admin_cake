						...
						<section id="center_column" class="col-md-12">
							...
							<ul class="step clearfix" id="order_step">
								<li class="col-md-2-4 col-xs-12 step_done_last step_done first">
									<a href="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/order">
									<em>01.</em> Summary
									</a>
								</li>
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
									<form action="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/login" method="post" id="create-account_form" class="box">
										...
										<div class="form_content clearfix">
											...
											<div class="submit">
												<input type="hidden" class="hidden" name="back" value="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/order?step=1&amp;multi-shipping=0" />						<button class="btn btn-default button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate">
												<span>
								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
									<form action="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/login" method="post" id="login_form" class="box">
										...
										<div class="form_content clearfix">
											...
											<p class="lost_password form-group"><a href="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/password-recovery" title="Recover your forgotten password" rel="nofollow">Forgot your password?</a></p>
											<p class="submit">
												<input type="hidden" class="hidden" name="back" value="http://www.demo4leotheme.com/prestashop/leo_styleshop_demo/en/order?step=1&amp;multi-shipping=0" />						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium">
												<span>
