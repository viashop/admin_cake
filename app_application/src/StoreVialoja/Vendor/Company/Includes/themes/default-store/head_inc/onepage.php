<head>
    ...
    <script type="text/javascript" src="/superstore/js/mage/directpost.js"></script>
    <script type="text/javascript" src="/superstore/js/mage/captcha.js"></script>
    <script type="text/javascript" src="/superstore/js/mage/centinel.js"></script>
    <script type="text/javascript" src="/superstore/js/varien/weee.js"></script>
