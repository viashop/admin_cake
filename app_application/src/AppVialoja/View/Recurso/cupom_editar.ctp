...
<form action="<?php echo Router::url(); ?>" method="post" class="form-horizontal">
    <div class="box">
        <div class="box-header">
            <h3 class="pull-left">Editando cupom</h3>
        ...
        <div class="box-content">
            <div class="control-group">
                ...
                <div class="controls">
                    <select class="input-small" id="id_ativo" name="ativo">
                        ...
                        ?>
                        <option value="True" <?php if (!(strcmp("True", $cupom['ShopCupomDesconto']['ativo']))) {echo 'selected="selected"';} ?>>Sim</option>
                        <option value="False" <?php if (!(strcmp("False", $cupom['ShopCupomDesconto']['ativo']))) {echo 'selected="selected"';} ?>>Não</option>
                        <?php
                        }
                        ?>
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <p>
                        <input id="id_codigo" maxlength="32" class="span4" name="codigo" type="text" value="<?php echo $cupom['ShopCupomDesconto']['codigo']?>" required />
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    ...
                    if (\Lib\Tools::getValue("descricao") !='') {
                        ...
                        echo $cupom['ShopCupomDesconto']['descricao'];
                    }
                    ?></textarea>
                    <?php
                ...
                <div class="controls">
                    <select id="id_tipo" name="tipo">
                        ...
                        ?>
                            ...
                            <option value="fixo" <?php if (!(strcmp("fixo", $cupom['ShopCupomDesconto']['tipo']))) {echo 'selected="selected"';} ?>>Valor fixo</option>
                            <option value="porcentagem"<?php if (!(strcmp("porcentagem", $cupom['ShopCupomDesconto']['tipo']))) {echo 'selected="selected"';} ?>>Porcentagem</option>
                            <option value="frete_gratis" <?php if (!(strcmp("frete_gratis", $cupom['ShopCupomDesconto']['tipo']))) {echo 'selected="selected"';} ?>>Frete grátis</option>
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <div class="input-prepend input-append"><span class="add-on fixo hide">R$</span><input class="input-small" id="id_valor" name="valor" type="text" value="<?php echo \Lib\Tools::convertToDecimalBR($cupom['ShopCupomDesconto']['valor']);?>" /><span class="add-on porcentagem hide">%</span></div>
                    <?php
                    if (isset($error_valor)) {
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <div class="input-prepend input-append"><span class="add-on">R$</span><input class="input-small" id="id_valor_minimo" name="valor_minimo" type="text" value="<?php echo \Lib\Tools::convertToDecimalBR($cupom['ShopCupomDesconto']['valor_minimo']); ?>" /></div>
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <input class="span2" id="id_quantidade" name="quantidade" type="text" value="<?php echo $cupom['ShopCupomDesconto']['quantidade']?>" />
                    <?php
                    if (isset($error_quantidade)) {
                        echo '<ul class="errorlist"><li>Este campo é obrigatório.</li></ul>' . PHP_EOL;
                    }
            ...
            <div class="control-group obrigatorio campo_nome ">
                ...
                <div class="controls">
                    <select id="id_cumulativo" class="span2" name="cumulativo">
                        <option value="False" <?php if (!(strcmp("False", $cupom['ShopCupomDesconto']['cumulativo']))) {echo 'selected="selected"';} ?>>Não</option>
                        <option value="True" <?php if (!(strcmp("True", $cupom['ShopCupomDesconto']['cumulativo']))) {echo 'selected="selected"';} ?>>Sim</option>
                    </select>
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <input class="input-mini" id="id_quantidade_por_cliente" name="quantidade_por_cliente" type="text" value="<?php echo $cupom['ShopCupomDesconto']['quantidade_por_cliente']?>" />
            ...
            <div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
                ...
                <div class="controls">
                    <input class="input-small span2" id="id_validade" name="validade" type="text" value="<?php 

                    if ($cupom['ShopCupomDesconto']['validade'] !='0000-00-00'
                        && !empty($cupom['ShopCupomDesconto']['validade'])) {
            ...
            <div class="control-group obrigatorio campo_nome aplicar-no-total ">
                ...
                <div class="controls">
                    <select id="id_aplicar_no_total" name="aplicar_no_total">
                        <option value="True" <?php if (!(strcmp("True", $cupom['ShopCupomDesconto']['aplicar_no_total']))) {echo 'selected="selected"';} ?>>Sim</option>
                        <option value="False" <?php if (!(strcmp("False", $cupom['ShopCupomDesconto']['aplicar_no_total']))) {echo 'selected="selected"';} ?>>Não</option>
                    </select>
