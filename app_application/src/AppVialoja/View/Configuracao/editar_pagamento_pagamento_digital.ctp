        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <div class="control-group conheca">
                    <p>Conheça <a href="http://bcash.com.br/para-quem-vende/" target="_blank">Bcash</a>!</p>
                    <p>Siga os seguintes passos para configurar:</p>
                    <p>1. Preencha o campo Seu email no Bcash com seu email de cadastro no Bcash;</p>
                    <p>2. Entre no <a href="https://www.bcash.com.br" target="_blank">Bcash</a>, clique em <strong>Ferramentas -> Código de Integração</strong> e copie <strong>Sua Chave acesso</strong> e cole no campo <strong>Sua Chave acesso</strong>.
                ...
                <div id="forma-pagamento-corpo" class="">
                    ...
                    <div class="control-group <?php echo $error; ?> usuario">
                        ...
                        <label class="control-label" for="id_usuario"><strong>Seu e-mail no Bcash</strong></label>
                        <div class="controls">
                    ...
                    <div class="control-group <?php echo $error ?> token">
                        <label class="control-label" for="id_token"><strong>Sua chave de acesso</strong></label>
                        <div class="controls">
                            ...
                            if (isset($token_invalido)) {
                                echo '<ul class="errorlist"><li>Chave de Acesso inválido.</li></ul>' . PHP_EOL;
                        ...
                        <div class="controls">
                            <div class="alert alert-info alert-block">
                                ...
                                <ol>
                                    ...
                                    <li>Na mesma página onde você adquiriu a Sua Chave acesso, tem um campo chamado <strong>URL de retorno da sua loja</strong>, preencha com <b><?php echo $url_notificacao; ?></b> e deixe o campo <strong>URL de aviso da sua loja</strong> em branco.</li>
                                </ol>
