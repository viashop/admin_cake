...
<div class="bread-container">
    <ul class="breadcrumb">
		...
		<li><a href="<?php echo VIALOJA_PAINEL ?>/configuracao/envio/personalizado/<?php echo $id_envio_personalizado ?>/editar"><i class="icon-wrench"></i> Envio &quot;<?php echo $nome_frete_personalizado; ?>&quot;</a> <span class="bread-separator">-</span></li>
		<li><span>Editar região</span></li>
    </ul>
</div>
...
<form class="form-horizontal" action="<?php echo Router::url(); ?>" method="post">
	<div class="box">
		<div class="box-header">
			<h3 class="pull-left">Editando região para <?php echo $nome_frete_personalizado; ?></h3>
		</div>
		<div class="box-content">
			<div class="form-group ">
				...
				<div class="col-sm-9">
					<select class="form-control" id="id_pais" name="pais">
						<option value="<?php echo $regiao['ShopEnvioPersonalizadoRegiao']['pais'] ?>" selected="selected"><?php echo $regiao['ShopEnvioPersonalizadoRegiao']['pais'] ?></option>
					</select>
				</div>
			</div>
			<?php
			...
			<div class="form-group <?php echo $error ?>">
				...
				<div class="col-sm-9">
					...
					<input class="form-control" id="id_nome" name="nome" type="text" value="<?php echo $regiao['ShopEnvioPersonalizadoRegiao']['nome'] ?>" />
			...
			<div class="form-group <?php echo $error ?>">
				...
				<div class="col-sm-9">
					...
					<input class="form-control" id="id_ad_valorem" name="ad_valorem" type="text" value="<?php if ($regiao['ShopEnvioPersonalizadoRegiao']['ad_valorem']>0) {
			...
			<div class="form-group <?php echo $error ?>">
				...
				<div class="col-sm-9">
					...
					<input class="form-control" id="id_kg_adicional" name="kg_adicional" type="text" value="<?php

					if ($regiao['ShopEnvioPersonalizadoRegiao']['kg_adicional'] > 0) {
						echo \Lib\Tools::convertToDecimalBR( $regiao['ShopEnvioPersonalizadoRegiao']['kg_adicional'] );
					}
