                            ...
                            <div class="box">
                                ...
                                <div>
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a class="" href="/suporte/ticket/enviarticket/" title="Enviar ticket"><i class="fa fa-mail-forward fa-2x"></i> <span style="font-size:30px">Enviar Novo Ticket</span></a></li>
                                    </ul>
                                </div>
                                <div class="box-body">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <th class="bg-light-blue" style="width: 60px; text-align:center;">Site</th>
                                        ...
                                        if( ! \Respect\Validation\Validator::notBlank()->validate( $results ) ){
                                            echo '<tr>
                                                    <td colspan="7" align="center">Nenhum ticket encontrado</td>
                                                </tr>';
                                            ...
                                            foreach ($results as $ticket) {
                                                ...
                                                $nome_dominio = $this->requestAction(
                                                    array(
                                                        'controller' => 'ShopDominio',
                                                        'action' => 'getUrlDominioShop',
                                                        'id_shop' => $ticket['Ticket']['id_shop_default']
                                                    ) 
                                                );

                                                printf('<a href="http://%s" target="_blank" title="URL Loja Virtual"><i class="fa fa-external-link"></i></a>', $nome_dominio);
