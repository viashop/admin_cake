	...
	<div class="box">
		...
		<div class="box-content">
			...
			<div class="control-group obrigatorio campo_nome <?php echo $error; ?>">
				...
				<div class="controls">
					<input class="campo_principal urlify" id="id_nome" required maxlength="128" name="nome" rel=".url-slug,#id_apelido" type="text" />
					<div class="control-seamless-editable">
						<span class="control">http://<?php echo $url_shop; ?>/m/<span class="url-slug">-</span></span>
						<input id="id_apelido" maxlength="128" name="apelido" type="text" />
					</div>
					<?php
                    if (isset($error_nome)) {
			...
			<div class="control-group <?php echo $error; ?>">
				...
				<div class="controls">
					...
					<textarea cols="40" id="id_descricao" name="descricao" rows="4"></textarea>
					<?php
                    if (isset($error_nome_comp)) {
                        echo '<ul class="errorlist"><li>Certifique-se de que o valor tenha no máximo 128 caracteres (ele possui '. $error_nome_comp .').</li></ul>' . PHP_EOL;
                    }
                    ?>
				</div>
			</div>
