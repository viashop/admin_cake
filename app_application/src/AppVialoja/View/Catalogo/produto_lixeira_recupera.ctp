<div class="bread-container">
    <ul class="breadcrumb">
        ...
        <li><span>Recuperar produto</span></li>
    </ul>
</div>
...
<form class="horizontal-form" action="<?php echo Router::url(); ?>" method="post">
    <div class="box">
        <div class="box-header">
            <h3 class="pull-left">Recuperar produto</h3>
        </div>
        <div class="box-content">
            ...
            if ($total > 1) {
                echo 'Deseja realmente recuperar os produtos abaixo?' . PHP_EOL;
            } else {
                echo 'Deseja realmente recuperar o produto abaixo?' . PHP_EOL;
            }
            ?>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary" id="processando"><i class="glyphicon glyphicon-ok"></i> 
                <?php
                if ($total > 1) {
                    echo 'Recuperar produtos' . PHP_EOL;
                } else {
                    echo 'Recuperar produto' . PHP_EOL;
                }
                ?>
                </button>&nbsp;&nbsp;&nbsp;&nbsp; <span class="text-muted">ou</span> &nbsp;&nbsp;&nbsp;<a href="<?php echo VIALOJA_PAINEL ?>/catalogo/produto/listar" class="btn btn-default"> <span class="glyphicon glyphicon-remove"></span> Cancelar</a>
