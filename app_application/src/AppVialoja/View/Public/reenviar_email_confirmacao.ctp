    ...
    <div class="fixed-width">
        <div class="one-column column cols" id="le_body_row_1_col_1">
            <div class="element-container cf" data-style="" id="le_body_row_1_col_1_el_1">
                <div class="element">
                    <h2 style='font-size:30px;color:#009BCB;text-align:left;'>Reenviar mensagem de confirmação de email</h2>
                </div>
            </div>

            <div class="element-container cf" data-style="" id="le_body_row_1_col_1_el_2">
                <div class="element">
                    <h2 style='font-size:14px;font-family:Arial, sans-serif;font-style:normal;font-weight:normal;color:#666666;text-align:center;margin-top:10px;'>Para reenviar a mensagem de confirmação de email,
                por favor preencha abaixo o email cadastrado.</h2>
                </div>
            </div>
                ...
                <div class="element">
                    <div id="5625d31069d67" class="optin-box optin-box-24" style="margin-right: auto;margin-left: auto;">
                        <form action="<?php echo Router::url(); ?>" method="post" class="cf op-optin-validation">
                            ...
                            <input type="email" required="required" name="email" placeholder="email@exemplo.com.br" value="<?php echo \Lib\Tools::clean( \Lib\Tools::getValue('email') ); ?>" />
                            ...
                            <div style="text-align:center">
                                ...
                                <button type="submit" id="btn_1_9894b86652d2e265a6e99705ac3ad7f9" class="css-button style-1 location_optin_box_style_24"><span class="text">Reenviar Confirmação</span><span class="hover"></span><span class="active"></span></button>
