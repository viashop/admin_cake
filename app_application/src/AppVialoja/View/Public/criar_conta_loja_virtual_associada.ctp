	...
	<div class="fixed-width">
		<div class="one-half column cols" id="le_body_row_2_col_1">
			<div class="element-container cf" data-style="" id="le_body_row_2_col_1_el_1">
				<div class="element">
					<h2 style='font-size:40px;text-align:left;margin-bottom:20px; margin-top: -70px;'>Gerenciar Loja Virtual</h2>
				</div>
			</div>
			<div class="element-container cf" data-style="" id="le_body_row_2_col_1_el_2">
				<div class="element">
					<ul class="bullet-list 1" >
						<li style='background-image:url("http://vialoja.com.br/d/wp-content/plugins/optimizePressPlugin/lib/assets/images/bullet_block/32x32/13.png");background-repeat:no-repeat;font-size:30px;font-style:normal;font-weight:normal;'>Cadastrar</li>
						<li style='background-image:url("http://vialoja.com.br/d/wp-content/plugins/optimizePressPlugin/lib/assets/images/bullet_block/32x32/13.png");background-repeat:no-repeat;font-size:30px;font-style:normal;font-weight:normal;'>Editar</li>
						<li style='background-image:url("http://vialoja.com.br/d/wp-content/plugins/optimizePressPlugin/lib/assets/images/bullet_block/32x32/13.png");background-repeat:no-repeat;font-size:30px;font-style:normal;font-weight:normal;'>Excluir</li>
						<li style='background-image:url("http://vialoja.com.br/d/wp-content/plugins/optimizePressPlugin/lib/assets/images/bullet_block/32x32/13.png");background-repeat:no-repeat;font-size:30px;font-style:normal;font-weight:normal;'>Monitorar</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="element">
					...
					<div id="562676b12b088" class="optin-box optin-box-24" style="margin-right: auto;margin-left: auto; margin-top: -70px;">
						...
						<div class="element-container cf" data-style="" id="le_body_row_1_col_1_el_1">
							<div class="element">
								<h2 style='font-size:30px;font-style:normal;font-weight:normal;color:#009BCB;text-align:left;'>Criar conta <strong>Administrativa</strong></h2>
							</div>
						</div>
