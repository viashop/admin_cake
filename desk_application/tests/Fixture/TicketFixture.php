...
class TicketFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ticket_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_shop_default'], 'references' => ['sh_shop', 'id_shop'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'ticket_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_prioridade_default'], 'references' => ['sh_ticket_prioridade', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ticket_ibfk_3' => ['type' => 'foreign', 'columns' => ['id_departamento_default'], 'references' => ['sh_ticket_departamento', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
