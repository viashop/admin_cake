...
class TicketController extends AppController
{
    ...
    /**
     * Method usage em Element
     * @return array Content Conteudo
     */
    public function getAssuntoConteudoTicket()
    {

       $this->loadModel('Conteudo');
       $breadcrumb=$this->Conteudo->breadcrumb($this->request->id);
       print $breadcrumb->assunto;
       $this->render(false);
