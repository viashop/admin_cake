...
$(document).ready(function() {
    ...
    $('#id_apelido').keyup(function(event){
...
/* Esconder div de erro em wizard passo-1*/
window.onload = function() {
    var h = document.getElementsByName("dominio")[0];
    var div = document.getElementById("esconder_div");
