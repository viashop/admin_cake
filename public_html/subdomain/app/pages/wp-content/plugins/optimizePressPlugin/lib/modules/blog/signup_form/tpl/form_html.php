...
<div class="op-signup_form-form_html<?php echo $signup_form_additional_class; ?>">
    ...
    <p class="cf field-welcome-email">
        <input type="checkbox" name="<?php echo $fieldname ?>[form_html][welcome_email]" id="<?php echo $id ?>welcome_email" value="Y"<?php echo ($fields['welcome_email'] == 'Y' ? ' checked="checked"' : '') ?> class="welcome_email" />
        <label for="<?php echo $id ?>welcome_email"><?php _e('Welcome Email', 'optimizepress') ?></label>
    </p>
