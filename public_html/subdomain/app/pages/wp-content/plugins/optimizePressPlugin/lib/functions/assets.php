            ...
            foreach($files as $file => $url){
                ...
                if ($isOpppStyle && $disableOpppStyles) {
                    if ( ! $shownOpppUpsellBox) {
                        $styles['oppp'] = '<li class="op-asset-dropdown-list-item">' . OptimizePress_Oppp_Assets::getUpsellBox() . '</li>';
                    }

                    $styles[$file] = '<li class="op-asset-dropdown-list-item optimize-press-is-oppp-element"><img alt="'.esc_attr($file).'" src="'.esc_url($url).'" /></li>';
                } else if ($isOpppStyle) {
                    if ( ! $shownOpppUpsellBox) {
                        $styles['oppp'] = '<li class="op-asset-dropdown-list-item">' . OptimizePress_Oppp_Assets::getUpsellBox() . '</li>';
                    }
