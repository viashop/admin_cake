<div class="op-bsw-grey-panel-content op-bsw-grey-panel-no-sidebar cf">        
    ...
    <p class="op-micro-copy"><a href="https://admin.icontact.com/icp/core/externallogin?sAppId=<?php echo OP_ICONTACT_APP_ID; ?>" target="_blank"><?php _e('Get API password', 'optimizepress'); ?></a></p>
