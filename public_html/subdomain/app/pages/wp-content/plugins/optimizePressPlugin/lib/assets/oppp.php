...
class OptimizePress_Oppp_Assets
{
    ...
    public function addOpppElementsToList($assets)
    {
        ...
        $assets['addon']['op_comparison_table'] = array(
            'title'         => __('Comparison Table', 'optimizepress'),
            'description'   => __('Comparison Table element description', 'optimizepress'),
            'settings'      => 'Y',
        ...
        $assets['addon']['op_product_showcase'] = array(
            ...
            'description'   => __('Product Showcase element description', 'optimizepress'),
            'settings'      => 'Y',
        ...
        $assets['addon']['op_testimonial_slider'] = array(
            ...
            'description'   => __('Testimonial Slider element description', 'optimizepress'),
            'settings'      => 'Y',
    ...
    public function advancedElementOptions()
    {
        ...
        <div style="margin-top: 20px; margin-right: 30px;">
            <?php
                ...
                $content = '<strong>OPTIMIZEPRESS PLUS PACK</strong> Bonus elements for the LiveEditor are avaliable fpr users with the OptimizePress Pluspack.';
                $content .= 'To find out more about the additional features and elements included in the Plus Pack - ';
    ...
    public static function getUpsellBox($element)
    {
        ...
        $html .= '<p class="oppp-upsell-copy">' . $element . ' element is avaliable for users with the OptimizePress Plus Pack. To find out more about the additional features and elements included in the Plus Pack -  <a href="http://www.optimizepress.com/plus-pack/"
