<div id="op_asset_browser_container" style="display:none">
    ...
    <ul id="op_asset_browser_slider">
        ...
        <li id="op_asset_browser_slide1" class="op_asset_browser_slide">
            ...
            echo '
            <div class="asset-title cf"><a href="#" class="op-slide-link" style="opacity:0; pointer-events:none; cursor:default;"></a><span class="title-text">'.__('Insert an Element', 'optimizepress').'</span></div>
            <div class="asset-second asset-filter"><input type="text" placeholder="'.__('Search for an Element', 'optimizepress').'" id="op_assets_filter" autofocus="autofocus" /></div><div class="op-hidden" id="op_asset_browser_no_assets"><p>'.__('There are no assets matching your search, please try again.', 'optimizepress').'</p></div>';
                    ...
                    if($add_group_header){
                        ...
                        switch($group){
                            case 'core':
                                ...
                                break;
                            case 'addon':
                                $header = __('Plus Pack Elements', 'optimizepress');
                                break;
                            case 'theme':
        ...
        <li id="op_asset_browser_slide2" class="op_asset_browser_slide">
            <div class="op_asset_content">
                <div class="asset-title cf"><a href="#1" tabindex="-1" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element', 'optimizepress'); ?>"></a><span class="title-text"><?php _e('Choose the Element Style', 'optimizepress')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_2') ?></div></div>
                <!--<div class="asset-second"><a href="#1" class="op-slide-link"><?php _e('&larr; Back to Choose an Element', 'optimizepress')?></a></div>-->
            </div>
        </li>
        <li id="op_asset_browser_slide3" class="op_asset_browser_slide">
            <div class="op_asset_content">
                <div class="asset-title cf"><a href="#2" tabindex="-1" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element Style', 'optimizepress'); ?>"></a><span class="title-text"><?php _e('Step 3', 'optimizepress')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_3') ?></div></div>
            </div>
        </li>
        <li id="op_asset_browser_slide4" class="op_asset_browser_slide">
            <div class="op_asset_content">
                <div class="asset-title cf"><a href="#3" tabindex="-1" class="op-slide-link tooltip animated pulse" title="<?php esc_attr_e('Choose a Different Element Setting', 'optimizepress'); ?>"></a><span class="title-text"><?php _e('Step 4', 'optimizepress')?></span> <div class="help-vid-link tooltip animated pulse" title="Help"><?php op_asset_help_vid('step_4') ?></div></div>
            </div>
        </li>
    </ul>
