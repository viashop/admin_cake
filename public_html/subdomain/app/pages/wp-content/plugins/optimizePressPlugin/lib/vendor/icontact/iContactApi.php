...
class OP_iContactApi {
    ...
    **/
    public function getUrl($bFull = false) {
        // Set the sandbox URL
        $sSandboxUrl = defined('ICONTACT_APISANDBOXURL') ? constant('ICONTACT_APISANDBOXURL') : 'https://admin.sandbox.icontact.com/icp';
        // Set the production URL
        $sApiUrl     = defined('ICONTACT_APIURL')        ? constant('ICONTACT_APIURL')        : 'https://admin.icontact.com/icp';
