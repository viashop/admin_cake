                        ...
                        form_html: {
                            ...
                            fields: {
                                ...
                                list: {
                                    title: 'provider_list',
                                    type: 'select',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'mailpoet', 'emma', 'egoi', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'constantcontact', 'convertkit', 'officeautopilot', 'ontraport', 'activecampaign', 'maropost']},
                                    events: {
                                        change: function(e) {
                                            /*
                                ...
                                loading_time: {
                                    type: 'paragraph',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'mailpoet', 'mailpoet', 'emma', 'egoi', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'constantcontact', 'convertkit', 'officeautopilot', 'ontraport', 'activecampaign', 'maropost']},
                                    ...
                                    events: {
                                        change: function(e) {
                                            if (e.currentTarget.checked == true) {
                                                $('.field-welcome_email').hide();
                                            } else if ($('#op_assets_core_optin_box_tabs_form_html_integration_type').val() === 'mailchimp') {
                                                $('.field-welcome_email').show();
                                            }
                                        }
                                    },
                                ...
                                thank_you_page: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['mailchimp', 'mailpoet', 'emma', 'egoi', 'arpreach', 'aweber', 'icontact', 'getresponse', 'campaignmonitor', 'constantcontact', 'convertkit', 'officeautopilot', 'ontraport', 'activecampaign', 'maropost']}
                                },
                                ...
                                disable_name: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email', 'custom', 'oneshoppingcart', 'mailchimp', 'mailpoet', 'emma', 'egoi', 'arpreach', 'aweber', 'infusionsoft', 'icontact', 'getresponse', 'campaignmonitor', 'constantcontact', 'convertkit', 'officeautopilot', 'ontraport', 'activecampaign', 'maropost']}
                                },
                                name: {
                                    title: 'name',
                                    type: 'select',
